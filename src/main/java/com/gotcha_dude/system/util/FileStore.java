...
public class FileStore {
    ...
    public UpLoadFileInfo uploadFile(MultipartFile multipartFile, String extension) throws IOException {
        ...
        if(extension.equals("audio")){
            if (!checkAudioName(originalFileName)) {
                throw new IOException();
            }
        }
        if(extension.equals("image")){
            if (!checkImgName(originalFileName)) {
                throw new IOException();
            }
        }
     ...
     * 이미지 확장자인지 체크하는 메서드
     */
    public boolean checkImgName(String originalFileName) {
     ...
     * mp3 확장자인지 체크하는 메서드
     */
    public boolean checkAudioName(String originalFileName) {
